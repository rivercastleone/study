...
contract accesscontrol{
    ...
    function requestAuthentication(address user,address device, address fog) public onlyAdmin{
            
            emit Authenticated(user,device,fog);
            bytes32 UID= keccak256(device,fog,user,block.timestamp);
